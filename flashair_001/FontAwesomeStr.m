...
@implementation FontAwesomeStr



+ (NSString*)getICONBet001Str:(NSString *)key
{
    NSDictionary* dic = [self getDicBet_001];
    NSString* unicode = [dic objectForKey:key];
    return unicode;
}
...
+(NSDictionary*)getDic
{
    NSDictionary* dic = [NSDictionary dictionaryWithObjectsAndKeys: @"\uf000", @"fa-glass",
                         @"\uf001", @"fa-music",
                         @"\uf002", @"fa-search",
                         @"\uf003", @"fa-envelope-o",
                         @"\uf004", @"fa-heart",
